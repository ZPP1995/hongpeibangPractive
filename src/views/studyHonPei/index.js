...
class StudyHopei extends Component {
    constructor() {
        ...
        this.classfyListImg = [
            ...
            {
                imgName: "/FkU-5lDUu7y7CurjkdJYWh-ZIg3x?80X80&imageView2/1/w/80/h/80",
                title: "新手教程",
                path: '/lessonSeries'
            },
    ...
    render() {
        return (
          ...
          <span className={"shipu4"}>
            <img className={"shipu5"} src={"/img/Fj1u8rBVnt5DLwXqhx8QKlRPLoGI?48X48&imageView2/1/w/48/h/48"}
                 alt=""></img>
          </span>
                    <span className={"shipu6"}>
            <img className={"shipu7"} src={"/img/FjmYGE5z6RvQL-_fdLKuSGYfmwO2?48X48&imageView2/1/w/48/h/48"}
                 alt=""></img>
                    ...
                    <div className={"shipu15"}>
                        {
                            this.classfyListImg.map((v, i) => (
                                <div className={"shipu16"} key={i} onClick={() => {
...
//       const csrfToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOjAsImV4cCI6MTc2NDA0Mjg0//       const type = '3'
// //       const pageSize = '10'
// //       dispatch(() => {
