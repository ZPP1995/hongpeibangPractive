...
export default class Register extends React.Component{
                        ...
                        <div className={"yanzheng5"}>
                            ...
                            <div className={"yanzheng7"}>
                                ...
                                <div className={"yanzheng9"}>
                                    <img className={"yanzheng10"} src={"https://image.hongbeibang.com/FvouzJLfDehM1NfR7u-51rBxkxxu?20X20&imageView2/1/w/20/h/20" } alt=""></img>
                                </div>
                            </div>
    ...
    async addNext(){
        if(this.refs.yanzhengma.value.length === 4 && this.refs.phone.value.length !== 11){
            ...
            this.props.history.push({pathname:"/auth",state:{id:this.refs.phone.value,code:data.code,phoneNumber:this.refs.phone.value}})
         }   
    }
